...
namespace ER000
{
    partial class FrmMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            ucPanel1 = new ER000.Ctrls.UCPanel();
            ucTab1 = new ER000.Ctrls.UCTab();
            ...
            // barManager1
            // 
            barManager1.Bars.AddRange(new Bar[] { bar1, bar3 });
            barManager1.DockControls.Add(barDockControlTop);
            barManager1.DockControls.Add(barDockControlBottom);
            barManager1.DockControls.Add(barDockControlLeft);
            barManager1.DockControls.Add(barDockControlRight);
            barManager1.Form = this;
            barManager1.Items.AddRange(new BarItem[] { barBtnOpen, barBtnNew, barMdiChildrenListItem1, barStaticItemMsg, barBtnSave, barSubItem1, barBtnTemplate, barBtnDelete, barButtonItem5 });
            ...
            bar1.LinksPersistInfo.AddRange(new LinkPersistInfo[] { new LinkPersistInfo(barBtnOpen, true), new LinkPersistInfo(barBtnNew, true), new LinkPersistInfo(barBtnSave, true), new LinkPersistInfo(barBtnDelete, true), new LinkPersistInfo(barBtnTemplate, true), new LinkPersistInfo(barButtonItem5, true) });
            bar1.Offset = 273;
            bar1.Text = "Tools";
            // 
            // barBtnOpen
            ...
            barBtnOpen.ItemShortcut = new BarShortcut(System.Windows.Forms.Keys.Control | System.Windows.Forms.Keys.Q);
            barBtnOpen.Name = "barBtnOpen";
            barBtnOpen.PaintStyle = BarItemPaintStyle.CaptionGlyph;
            ...
            barBtnNew.ItemShortcut = new BarShortcut(System.Windows.Forms.Keys.Control | System.Windows.Forms.Keys.N);
            barBtnNew.Name = "barBtnNew";
            barBtnNew.PaintStyle = BarItemPaintStyle.CaptionGlyph;
            ...
            barBtnSave.ItemShortcut = new BarShortcut(System.Windows.Forms.Keys.Control | System.Windows.Forms.Keys.S);
            barBtnSave.Name = "barBtnSave";
            barBtnSave.PaintStyle = BarItemPaintStyle.CaptionGlyph;
            ...
            barBtnDelete.PaintStyle = BarItemPaintStyle.CaptionGlyph;
            ...
            barBtnTemplate.ItemShortcut = new BarShortcut(System.Windows.Forms.Keys.Control | System.Windows.Forms.Keys.O);
            barBtnTemplate.Name = "barBtnTemplate";
            barBtnTemplate.PaintStyle = BarItemPaintStyle.CaptionGlyph;
            barBtnTemplate.ShortcutKeyDisplayString = "O";
            ...
            bar3.LinksPersistInfo.AddRange(new LinkPersistInfo[] { new LinkPersistInfo(barMdiChildrenListItem1), new LinkPersistInfo(barStaticItemMsg) });
            ...
            bar2.LinksPersistInfo.AddRange(new LinkPersistInfo[] { new LinkPersistInfo(barBtnOpen), new LinkPersistInfo(barBtnNew), new LinkPersistInfo(barBtnSave) });
            bar2.Offset = 169;
            bar2.Text = "Tools";
            // 
            // simpleButton1
        ...
        private ER000.Ctrls.UCPanel ucPanel1;
        private ER000.Ctrls.UCTab ucTab1;
